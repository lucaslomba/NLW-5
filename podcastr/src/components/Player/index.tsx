...
export function Player(){
    const { episodeList, currentEpisodeIndex, isPlaying, hasNext, hasPrevious, isLooping, isShuffling, clearPlayingState, toggleShuffle, toggleLoop, togglePlay, setPlayingState, playNext, playPrevious } = useContext(PlayerContext)
